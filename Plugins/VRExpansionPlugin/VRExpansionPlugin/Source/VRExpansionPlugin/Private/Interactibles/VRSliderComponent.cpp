...
void UVRSliderComponent::CheckSliderProgress()
{
	...
	else if ((LastSliderProgressState != CurrentSliderProgress) || bHitEventThreshold)
	{
		...
		if ((!bSliderUsesSnapPoints && (CurrentSliderProgress == 1.0f || CurrentSliderProgress == 0.0f)) ||	(bSliderUsesSnapPoints && SnapIncrement > 0.f && (FMath::IsNearlyEqual(ModValue, 0.0f, 0.001f) || FMath::IsNearlyEqual(ModValue, SnapIncrement, 0.00001f)))	)
		{
